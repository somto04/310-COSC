...
@patch("app.routes.adminRoute.saveReviews")
@patch("app.routes.adminRoute.incrementPenaltyForUser")
@patch("app.routes.adminRoute.validateReview")
@patch("app.routes.adminRoute.loadReviews")
@patch("app.routes.adminRoute.requireAdmin", new=mockRequireAdmin)
...
@patch("app.routes.adminRoute.requireAdmin", new=mockRequireAdmin)
@patch("app.routes.adminRoute.getFlaggedReviews")
def test_paginated_sorted_filtered_reviews(mockGetFlagged, client):
    ...
    response = client.get("/admin/reports/reviews?page=1&pageSize=2&sortBy=mostFlagged&minFlags=4")
    data = response.json()
...
@patch("app.routes.adminRoute.requireAdmin", new=mockRequireAdminFail)
