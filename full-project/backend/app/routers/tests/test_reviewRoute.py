...
class TestReviewRouterIntegration:
    ...
    @patch("app.routers.reviewRoute.searchReviews")
    def test_search_reviews_with_limit_and_offset(
        self, mock_search, client, sample_reviews_list
    ):
    ...
    def test_create_review_endpoint(self, mock_create, client, sample_review_data, app):
        """Test POST /reviews/{movieId} creates a new review"""
    ...
    def test_update_review_endpoint(
        self, mock_get_review, mock_update, client, sample_review_data, app
    ):
        ...
        update_data = ReviewUpdate(reviewBody="Updated review text", rating=4)
    ...
    @patch("app.routers.reviewRoute.getReviewById")
    def test_delete_review_as_admin(
        self, mock_get_review, mock_delete, client, sample_review_data, app
    ):
        app.dependency_overrides[getCurrentUser] = lambda: FakeUser(
